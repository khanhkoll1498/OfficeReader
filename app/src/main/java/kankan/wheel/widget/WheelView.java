...
public class WheelView extends View {
    ...
    private void b(Canvas var1) {
        ...
        Double.isNaN(var3);
        Double.isNaN(var3);
        int var5 = (int)(var3 * 1.2D);
        //this.g.setBounds(0, var2 - var5, this.getWidth(), var2 + var5);
        //this.g.draw(var1);
    }
    ...
    private int c(int var1, int var2) {
        ...
        this.m.measure(MeasureSpec.makeMeasureSpec(var1, 0), MeasureSpec.makeMeasureSpec(0, 0));
        ...
        this.m.measure(MeasureSpec.makeMeasureSpec(var1 - 20, 1073741824), MeasureSpec.makeMeasureSpec(0, 0));
        return var1;
    }
    ...
    private boolean c(int var1) {
        e var2 = this.o;
        boolean var3;
        if (var2 == null || var2.getItemsCount() <= 0 || !this.a && (var1 < 0 || var1 >= this.o.getItemsCount())) {
            var3 = false;
        } else {
            var3 = true;
        }
    ...
    private void e() {
        /*if (this.g == null) {
            //this.g = this.getContext().getResources().getDrawable(kankan.wheel.widget.e.a.sodk_wheel_wheel_val);
        }

        if (this.h == null) {
            this.h = new GradientDrawable(Orientation.TOP_BOTTOM, c);
        }

        if (this.i == null) {
            this.i = new GradientDrawable(Orientation.BOTTOM_TOP, c);
        }*/

        //this.setBackgroundResource(kankan.wheel.widget.e.a.sodk_wheel_wheel_bg);
    }
    ...
    private boolean f() {
        ...
        boolean var5 = var4;
        if (!var4) {
            if (this.n == var1.a() && this.m.getChildCount() == var1.c()) {
                var5 = false;
            } else {
                var5 = true;
            }
