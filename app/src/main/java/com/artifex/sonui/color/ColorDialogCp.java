...
package com.artifex.sonui.color;
...
import com.artifex.sonui.NUIPopupWindow;
import com.artifex.sonui.editor.ColorChangedListener;
...
public class ColorDialogCp implements OnTouchListener, OnDismissListener {
    public static final int BG_COLORS = 2;
    public static final int FG_COLORS = 1;
    private static ColorDialogCp f;
    ...
    public ColorDialogCp(int var1, Context var2, SODoc var3, View var4, ColorChangedListener var5) {
        this.a = var2;
        this.b = var4;
        this.c = var5;
        this.d = var1;
    ...
    public void show() {
        ...
        for (int var8 = 0; var4 < 3; ++var4) {
            ...
            for (int var10 = 0; var10 < var9; var8 = var12) {
                ...
                if (var12 <= var14.length) {
                    ...
                    var11.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(var14[var8])));
                    var11.setTag(var14[var8]);
                    var11.setOnClickListener(new OnClickListener() {
                        public void onClick(View var1) {
                            ColorDialogCp.this.c.onColorChanged((String) var1.getTag());
                            ColorDialogCp.this.onDismiss();
                        }
                    });
                } else {
        ...
        NUIPopupWindow var16 = new NUIPopupWindow(this.a);
        this.g = var16;
        ...
        this.g.showAtLocation(this.b, Gravity.CENTER, 50, 50);
    }
}