...
public class NUIDocViewXls extends NUIDocView {
    ...
    private void a(SOTextView var1, boolean var2) {
        int var3;
        if (var2) {
            var3 = ContextCompat.getColor(this.getContext(), color.sodk_editor_button_text);
        } else {
            var3 = -4473925;
        }
    ...
    private void b(String var1) {
        ...
        var2.setBackgroundDrawable(ContextCompat.getDrawable(this.activity(), drawable.sodk_editor_formula_popup));
        var2.setModal(true);
    ...
    public int getBorderColor() {
        return ContextCompat.getColor(this.getContext(), color.sodk_editor_header_xls_color);
    }
