...
import com.artifex.sonui.editor.NUIDocView.TabData;
...
public class NUIDocViewOther extends NUIDocView {
    ...
    protected void afterFirstLayoutComplete() {
        ...
        if (var1 == null || var1.compareToIgnoreCase("txt") != 0 && var1.compareToIgnoreCase("csv") != 0) {
            this.findViewById(id.search_toolbar).setVisibility(GONE);
            this.findViewById(id.first_page_button).setVisibility(GONE);
            this.findViewById(id.last_page_button).setVisibility(GONE);
            this.findViewById(id.reflow_button).setVisibility(GONE);
            this.findViewById(id.divider_1).setVisibility(GONE);
            this.findViewById(id.divider_2).setVisibility(GONE);
        } else {
            this.hideUnnecessaryDivider2(id.other_toolbar);
        }
    ...
    public NUIDocView.TabData[] getTabData() {
        if (this.b == null) {
            ...
            this.b = tabDataArr;
            NUIDocView.TabData tabData = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_file), R.id.fileTab, R.layout.sodk_editor_tab_one, 0);
            tabDataArr[0] = tabData;
            NUIDocView.TabData[] tabDataArr2 = this.b;
            NUIDocView.TabData tabData2 = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_pages), R.id.pagesTab, R.layout.sodk_editor_tab_right, 8);
    ...
    protected int getTabUnselectedColor() {
        return ContextCompat.getColor(this.getContext(), color.sodk_editor_header_other_color);
    }
    ...
    protected void hideUnnecessaryDivider2(int var1) {
        ...
        if (var2 != null) {
            ...
            for(var1 = 0; var3 < var2.getChildCount(); var1 = var6) {
                ...
                var6 = var5.getId();
                int var7;
                if (var6 != id.divider_1 && var6 != id.divider_2) {
                    var7 = var4;
                    var6 = var1;
    ...
    protected void onFullScreenHide() {
        this.findViewById(id.other_top).setVisibility(GONE);
    ...
    public void showUI(boolean var1) {
        View var2 = this.findViewById(id.other_top);
        if (var1) {
            var2.setVisibility(VISIBLE);
            this.findViewById(id.footer).setVisibility(VISIBLE);
            this.findViewById(id.header).setVisibility(VISIBLE);
        } else {
