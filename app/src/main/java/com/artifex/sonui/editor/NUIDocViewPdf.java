...
import com.artifex.sonui.editor.a.b;
...
public class NUIDocViewPdf extends NUIDocView {
    ...
    protected void afterFirstLayoutComplete() {
        ...
        this.imgColorButton = (ImageView) this.createToolbarButton(com.all.officereader.R.id.img_color_button);
        ...
        this.tvPrevious = (TextView) this.createToolbarButton(com.all.officereader.R.id.txt_previous);
        this.tvNext = (TextView) this.createToolbarButton(com.all.officereader.R.id.tv_next);
        this.imgPrevious = (ImageView) this.createToolbarButton(com.all.officereader.R.id.img_previous);
        this.imgNext = (ImageView) this.createToolbarButton(com.all.officereader.R.id.img_next);
    ...
    public NUIDocView.TabData[] getTabData() {
        NUIDocView.TabData tabData = null;
        if (this.p == null) {
            ...
            if (c2) {
                tabData = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_file), R.id.fileTab, R.layout.sodk_editor_tab_left, 0);
                tabDataArr[0] = tabData;
                NUIDocView.TabData[] tabDataArr2 = this.p;
                ...
                NUIDocView.TabData[] tabDataArr3 = this.p;
                NUIDocView.TabData tabData3 = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_redact), R.id.redactTab, R.layout.sodk_editor_tab, i2);
                tabDataArr3[2] = tabData3;
                NUIDocView.TabData[] tabDataArr4 = this.p;
                ...
                tabDataArr[0] = tabData;
                NUIDocView.TabData[] tabDataArr5 = this.p;
                NUIDocView.TabData tabData5 = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_annotate), R.id.annotateTab, R.layout.sodk_editor_tab, 8);
                tabDataArr5[1] = tabData5;
                NUIDocView.TabData[] tabDataArr6 = this.p;
                NUIDocView.TabData tabData6 = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_redact), R.id.redactTab, R.layout.sodk_editor_tab, i2);
                tabDataArr6[2] = tabData6;
                NUIDocView.TabData[] tabDataArr7 = this.p;
                NUIDocView.TabData tabData7 = new NUIDocView.TabData(getContext().getString(R.string.sodk_editor_tab_pages), R.id.pagesTab, R.layout.sodk_editor_tab_right, 0);
    ...
    protected void updateUIAppearance() {
        ...
        try {
            if (var10.canPrevious()) {
                tvPrevious.setTextColor(activity().getResources().getColor(com.all.officereader.R.color.blue));
                imgPrevious.setColorFilter(activity().getResources().getColor(com.all.officereader.R.color.blue));
            } else {
                tvPrevious.setTextColor(activity().getResources().getColor(com.all.officereader.R.color.black_trans));
                imgPrevious.setColorFilter(activity().getResources().getColor(com.all.officereader.R.color.black_trans));
            }

            if (var10.canNext()) {
                tvNext.setTextColor(activity().getResources().getColor(com.all.officereader.R.color.blue));
                imgNext.setColorFilter(activity().getResources().getColor(com.all.officereader.R.color.blue));
            } else {
                tvNext.setTextColor(activity().getResources().getColor(com.all.officereader.R.color.black_trans));
                imgNext.setColorFilter(activity().getResources().getColor(com.all.officereader.R.color.black_trans));
            }
