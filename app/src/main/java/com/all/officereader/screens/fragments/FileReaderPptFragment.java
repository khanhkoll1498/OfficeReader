...
public class FileReaderPptFragment extends BaseFragment implements FileAdsFragmentAdapter.fileAdsFragmentAdapterListener {
    ...
    public void updateData(){
        ...
        mFileArrayList.addAll(FileUtility.mPowerPointFiles);
    ...
    private void initDataRecent() {
        try {
            ...
            if (FileUtility.mPowerPointFiles.size() <=0){
