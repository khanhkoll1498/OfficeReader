...
public class FolderAdapter extends RecyclerView.Adapter {
    ...
    private FolderAdapter.onClickItem mOnClickItem;

    public void setOnClickItem(FolderAdapter.onClickItem mOnClickItem) {
    ...
    private void ItemHolder(@NonNull RecyclerView.ViewHolder holder1, final int position) {
        FolderAdapter.FileHolder holder = (FolderAdapter.FileHolder) holder1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup container, int viewType) {
        ...
        return new FolderAdapter.FileHolder(cell);
    }
