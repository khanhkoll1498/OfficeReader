...
public class GalleryAdapter extends RecyclerView.Adapter {
    ...
    private GalleryAdapter.onClickItem mOnClickItem;

    public void setOnClickItem(GalleryAdapter.onClickItem mOnClickItem) {
    ...
    private void ItemHolder(@NonNull RecyclerView.ViewHolder holder1, final int position) {
        GalleryAdapter.FileHolder holder = (GalleryAdapter.FileHolder) holder1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup container, int viewType) {
        ...
        return new GalleryAdapter.FileHolder(cell);
    }
