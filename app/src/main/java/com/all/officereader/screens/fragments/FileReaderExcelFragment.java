...
public class FileReaderExcelFragment extends BaseFragment implements FileAdsFragmentAdapter.fileAdsFragmentAdapterListener {
    ...
    public FileReaderExcelFragment() {
    }
    ...
    public void updateData(){
        ...
        mFileArrayList.addAll(FileUtility.mExcelFiles);
        initDataRecent();
    }
    ...
    private void initDataRecent() {
        try {
            ...
            if (FileUtility.mExcelFiles.size() <= 0) {
