...
public class FileReaderDocFragment extends BaseFragment implements FileAdsFragmentAdapter.fileAdsFragmentAdapterListener {
    ...
    public void updateData() {
        ...
        mFileArrayList.addAll(FileUtility.mWordFiles);
        initDataRecent();
    }
    ...
    private void initDataRecent() {
        try {
            ...
            if (FileUtility.mWordFiles.size() <= 0) {
