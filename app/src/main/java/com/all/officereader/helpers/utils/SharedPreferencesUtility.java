...
//        SharedPreferences preferences = context.getSharedPreferences(NAME_PREF, MODE_PRIVATE);
//        return preferences.getString(Constant.BILLING_PUBLIC_KEY, "");
//    }

//    public static void setBillingPublicKey(Context context, String getBillingPublicKey) {
//        SharedPreferences pref = context.getSharedPreferences(NAME_PREF, MODE_PRIVATE);
//        SharedPreferences.Editor editor = pref.edit();
//        editor.putString(Constant.BILLING_PUBLIC_KEY, getBillingPublicKey);
//        editor.apply();
//    }

    public static int getPointAds(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(NAME_PREF, MODE_PRIVATE);
        return preferences.getInt(Constant.POINT_ADS, 0);
    }

    public static void setPointAds(Context context, int getPointAds) {
        SharedPreferences pref = context.getSharedPreferences(NAME_PREF, MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt(Constant.POINT_ADS, getPointAds);
        editor.apply();
    }

    public static long getTimeRate(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(NAME_PREF, Context.MODE_PRIVATE);
        return preferences.getLong(SET_TIME_RATE, Constant.TIME_RATE_DEFAULT);
    }
